...
import { idCard, idCardTone, machineLine } from "../../components/identities/idCard";
import { date } from "../../lib/identities";
import { DAY, now, proofView } from "./views";

// covers: proofs.deck, proofs.expiry, proofs.revoke
...
describe("the ID card's face", () => {
  ...
  it("the blank card invites the first identity, then another", () => {
    const { rerender } = render(<AddIdCardFace first />);
    expect(screen.getByText("Add your first identity")).toBeInTheDocument();
