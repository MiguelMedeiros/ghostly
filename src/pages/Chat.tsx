...
export function Chat({ sessionId, visible, onCallChange, callLayer }: ChatProps) {
  ...
  const pay = useCallback(
    async (kind: "send" | "request", amount: number, memo: string, method?: "cashu" | "arkade" | "usdt" | "bark" | "bitcoin" | "fedimint"): Promise<string | null> => {
  ...
  const payRequest = useCallback((amount: number, memo: string, method?: "cashu" | "arkade" | "usdt" | "bark" | "bitcoin" | "fedimint") => pay("request", amount, memo, method), [pay]);
