  ...
  return (
    <>
      ...
      <button
        ...
        className={`voice-record-button relative w-10 h-10 max-md:w-11 max-md:h-11 flex items-center justify-center rounded-full shrink-0 cursor-pointer select-none bg-accent text-[#111b21] hover:bg-accent-hover transition-colors disabled:opacity-30 disabled:cursor-not-allowed ${unavailable ? "opacity-60" : ""}`}
      >
        {mode === "locked" ? (
