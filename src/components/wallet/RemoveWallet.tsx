...
async function reveal(wallet: WalletPlatform, type: WalletType): Promise<string> {
  switch (type) {
...
function exportBackup(wallet: WalletPlatform, type: WalletType, password: string): Promise<string> {
  switch (type) {
