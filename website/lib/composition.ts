...
export const BLOCKS: Block[] = [
  ...
  b("files", "talk", "Files", "available", ["500-files", "502-legacy-files"], "Verified transfers up to 100 MiB while both peers are online.", "Transferências verificadas de até 100 MiB com os dois peers online."),
