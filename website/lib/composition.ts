...
export const BLOCKS: Block[] = [
  ...
  // Groups
  b("groups", "groups", "Private groups", "development", ["900-group-sessions", "9xx-group-mesh"], "Up to eight members, text only, over a mesh of paired links derived from the roster. One admin; fresh keys at every change, so a removed member reads nothing after. Web, extension and desktop.", "Até oito membros, só texto, por uma malha de links pareados derivada da lista de membros. Um admin; chaves novas a cada mudança, então quem sai não lê mais nada. Web, extensão e desktop."),
