...
export const BLOCKS: Block[] = [
  ...
  b("media", "talk", "Voice & video", "available", ["600-media", "601-webrtc-media"], "One-to-one calls and screen sharing over WebRTC media, in every chat while it is live.", "Chamadas um a um e compartilhamento de tela por mídia WebRTC, em todo chat enquanto ele está ao vivo."),
