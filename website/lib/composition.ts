...
export const BLOCKS: Block[] = [
  ...
  b("atproto", "identity", "Bluesky / AT Protocol", "planned", ["3xx-atproto"], "A Bluesky (or any AT Protocol) account: approved once on your own server, published as one record in your repository, checked by contacts without logging in. Built; offered once the website's client document is live.", "Uma conta Bluesky (ou de qualquer servidor AT Protocol): aprovada uma vez no seu próprio servidor, publicada como um registro no seu repositório, verificada pelos contatos sem login. Pronta; oferecida quando o documento de cliente do site estiver no ar."),
  ...
  b("pubky", "identity", "Pubky", "available", ["302-pubky"], "A Pubky key, approved once in Pubky Ring or Pubky Passport: the proof is a small file on its homeserver, which contacts read through the key's own records.", "Uma chave Pubky, aprovada uma vez no Pubky Ring ou no Pubky Passport: a prova é um arquivo pequeno no homeserver dela, que os contatos leem pelos registros da própria chave."),
