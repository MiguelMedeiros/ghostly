      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="p-6 font-mono text-sm space-y-4">
            <div>
              <span className="text-gray-500"># Install via curl</span>
              <div className="flex items-start gap-2 mt-1">
                <span className="text-green">$</span>
                <span className="text-gray-300">curl -sSL https://ghostly.chat/install.sh | sh</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-start gap-2 mt-1">
                <span className="text-green">$</span>
                <span className="text-gray-300">ghostly new</span>
              </div>
              <div className="text-cyan/80 mt-1 ml-4">
                → Chat created! Share this link: ghostly://abc123...
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex items-start gap-2 mt-1">
                <span className="text-green">$</span>
                <span className="text-gray-300">ghostly send &quot;Hello from the terminal 👻&quot;</span>
              </div>
              <div className="text-cyan/80 mt-1 ml-4">
