        ...
        >
          ...
          <div className="group relative rounded-xl border border-border/50 bg-surface/50 p-5 hover:border-cyan/40 transition-all">
            ...
            <div className="flex flex-col gap-2">
              <a
                href="https://github.com/MiguelMedeiros/ghostly/releases/download/v0.1.3/Ghostly_0.1.3_aarch64.dmg"
              ...
              <a
                href="https://github.com/MiguelMedeiros/ghostly/releases/download/v0.1.3/Ghostly_0.1.3_x64.dmg"
          ...
          <div className="group relative rounded-xl border border-border/50 bg-surface/50 p-5 hover:border-cyan/40 transition-all">
            ...
            <div className="flex flex-col gap-2">
              <a
                href="https://github.com/MiguelMedeiros/ghostly/releases/download/v0.1.3/Ghostly_0.1.3_x64-setup.exe"
                className="flex items-center justify-between px-3 py-2 rounded-lg bg-cyan/10 text-cyan text-sm font-medium hover:bg-cyan/20 transition-colors"
              >
              ...
              <a
                href="https://github.com/MiguelMedeiros/ghostly/releases/download/v0.1.3/Ghostly_0.1.3_x64_en-US.msi"
                className="flex items-center justify-between px-3 py-2 rounded-lg bg-gray-800/50 text-gray-400 text-sm hover:bg-gray-800 hover:text-gray-200 transition-colors"
              >
          ...
          <div className="group relative rounded-xl border border-border/50 bg-surface/50 p-5 hover:border-cyan/40 transition-all">
            ...
            <div className="flex flex-col gap-2">
              <a
                href="https://github.com/MiguelMedeiros/ghostly/releases/download/v0.1.3/Ghostly_0.1.3_amd64.deb"
                className="flex items-center justify-between px-3 py-2 rounded-lg bg-cyan/10 text-cyan text-sm font-medium hover:bg-cyan/20 transition-colors"
              >
                <span>.deb</span>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
              ...
              <a
                href="https://github.com/MiguelMedeiros/ghostly/releases/download/v0.1.3/Ghostly_0.1.3_amd64.AppImage"
                className="flex items-center justify-between px-3 py-2 rounded-lg bg-gray-800/50 text-gray-400 text-sm hover:bg-gray-800 hover:text-gray-200 transition-colors"
              >
                <span>.AppImage</span>
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={2}>
