      ...
      <Block id="clients" title="Clients & Relays">
        ...
        <List
          items={[
            ...
            <>Every call negotiates a video section, voice calls included, left empty until someone turns a camera or a screen on. Switching one on is a <C>replaceTrack</C> on a section both sides already agreed on: no second offer, no ringing. A <C>{'{ "t": "v" }'}</C> signal tells the peer what the picture is now.</>,
