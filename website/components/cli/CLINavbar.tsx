    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <a href="/cli" className="flex items-center gap-2.5 group">
            <motion.div
              animate={{ y: [0, -2, 0] }}
              transition={{ duration: 2.5, repeat: Infinity, ease: "easeInOut" }}
              className="relative"
            >
              <svg className="w-6 h-6 text-green transition-all group-hover:text-cyan group-hover:scale-110 duration-300" viewBox="0 0 24 24" fill="currentColor">
            ...
            <span className="font-mono font-bold text-sm">
              ...
              <span className="text-green ml-1">CLI</span>
            </span>
          </a>
        </div>

        <div className="hidden md:flex items-center gap-8 text-sm text-gray-400 absolute left-1/2 -translate-x-1/2">
          <a href="#install" className="hover:text-green transition-colors">
            Install
          </a>
          <a href="#use-cases" className="hover:text-green transition-colors">
            Use Cases
          </a>
          <a href="#examples" className="hover:text-green transition-colors">
            Examples
          </a>
          <a href="#reference" className="hover:text-green transition-colors">
            Reference
          </a>
        </div>
