    ...
    >
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            href="/docs"
            className="px-4 py-1.5 rounded-lg text-gray-400 text-sm font-medium border border-border/50 hover:border-gray-500 hover:text-gray-200 transition-colors"
          >
            Docs
          </a>
          <a
