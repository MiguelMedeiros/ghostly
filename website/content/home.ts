  ...
  wallets: {
    ...
    cards: [
      ...
      },
      {
        ...
        limits: "Experimental. New profiles get a Bitcoin mainnet Ark wallet automatically, but payment flows were exercised only on a local test network; leaving Ark on your own is still a release gate. Ark via Bark is being built.",
      },
      {
        id: "usdt",
        name: "USDT",
  ...
  wallets: {
    ...
    cards: [
      ...
      },
      {
        ...
        limits: "Experimental. Perfis novos ganham automaticamente uma carteira Ark na mainnet do Bitcoin, mas os pagamentos foram exercitados só numa rede de teste local; sair do Ark por conta própria ainda é requisito de lançamento. Ark via Bark está sendo construído.",
      },
      {
        id: "usdt",
        name: "USDT",
