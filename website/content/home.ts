...
const en = {
  ...
  space: {
    ...
    lead: "Chats, keys, wallets and services live in the app, not on a server of ours.",
    profiles: {
      title: "Profiles for each part of your life",
      body: "Personal and Work on one device, each with its own chats, wallets and services; your contacts never learn the others exist.",
      level: "development" as Level,
      note: "Web and desktop; the extension runs one profile.",
      names: ["Personal", "Work", "Club"],
    },
    backup: {
      title: "Backup is what. Storage is where.",
      body: "A backup seals a whole profile into one bundle under your passphrase; storage is just where that bundle waits.",
      level: "development" as Level,
      what: "Backup",
      where: "Storage",
      whatItems: ["chats & keys", "wallets", "services", "settings"],
      whereItems: ["a file you keep", "S3 · R2 · B2 · MinIO"],
      note: "Restoring creates a new profile; nothing is overwritten.",
    },
    look: {
      title: "Make it look like you",
      body: "Four color themes, light or dark, eight languages and an app lock.",
      level: "released" as Level,
    },
  },
  wallets: {
...
const ptBr: HomeCopy = {
  ...
  space: {
    ...
    lead: "Chats, chaves, carteiras e serviços ficam no app, não num servidor nosso.",
    profiles: {
      title: "Perfis para cada parte da sua vida",
      body: "Pessoal e Trabalho no mesmo aparelho, cada um com seus chats, carteiras e serviços; seus contatos nunca ficam sabendo dos outros.",
      level: "development",
    ...
    backup: {
      ...
      body: "Um backup sela um perfil inteiro num pacote com a sua senha; o armazenamento é só onde esse pacote espera.",
      level: "development",
      what: "Backup",
      where: "Armazenamento",
      whatItems: ["chats e chaves", "carteiras", "serviços", "ajustes"],
      whereItems: ["um arquivo seu", "S3 · R2 · B2 · MinIO"],
      note: "Restaurar cria um perfil novo; nada é sobrescrito.",
    },
    look: {
