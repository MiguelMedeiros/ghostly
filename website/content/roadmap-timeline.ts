  ...
  lanes: [
    {
      ...
      items: {
        now: ["Paired chats: files, payments, local apps", "Calls in WebRTC chats", "Iroh and HyperDHT on desktop", "QR invitations", "Pairing progress you can watch", "Voice messages"],
        planned: ["Calls inside paired chats", "Local network discovery, QUIC and WebSocket relay profiles"],
  ...
  lanes: [
    {
      ...
      items: {
        now: ["Chats pareados: arquivos, pagamentos, apps locais", "Chamadas em chats WebRTC", "Iroh e HyperDHT no desktop", "Convites por QR", "Progresso do pareamento à vista", "Mensagens de voz"],
        planned: ["Chamadas dentro dos chats pareados", "Descoberta na rede local, perfis QUIC e relay WebSocket"],
