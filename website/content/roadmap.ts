  ...
  tracks: [
    {
      ...
      why: "Every new chat is the same kind now. Next it starts on the DHT when no direct path exists and goes live by itself, gets one ghostly1 invite, and gets calls.",
      now: [
        ...
        { text: "Calls and screen sharing with Ghostly 0.4 contacts", level: "available" },
      ...
      next: [
        ...
        { text: "Calls in every chat", level: "planned" },
      ],
  ...
  tracks: [
    {
      ...
      why: "Todo chat novo agora é do mesmo tipo. Em seguida ele começa na DHT quando não há caminho direto e passa sozinho ao link direto, ganha um único convite ghostly1 e ganha chamadas.",
      now: [
        ...
        { text: "Chamadas e compartilhamento de tela com contatos no Ghostly 0.4", level: "available" },
      ...
      next: [
        ...
        { text: "Chamadas em todo chat", level: "planned" },
      ],
