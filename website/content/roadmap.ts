  ...
  tracks: [
    {
      ...
      why: "Paired chats are the default now. Next they get what the older WebRTC chats still do better: calls.",
      now: [
  ...
  tracks: [
    {
      ...
      why: "Os chats pareados agora são o padrão. O próximo passo é dar a eles o que os chats WebRTC antigos ainda fazem melhor: chamadas.",
      now: [
