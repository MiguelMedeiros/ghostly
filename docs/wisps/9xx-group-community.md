...
[`group-community-join.spec.ts`](../../e2e/web/group-community-join.spec.ts) holds two joins in a row, a member's app open a minute and a quarter before, to 12 seconds in and 20 seconds to reach a member.
