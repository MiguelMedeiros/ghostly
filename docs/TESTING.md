...
**290 features**, 277 covered by at least one test (96%), 13 on the [allow-untested list](../e2e/allow-untested.json).

| | Unit | Rust | E2E web | E2E ext | E2E desktop | Gated |
|---|---:|---:|---:|---:|---:|---:|
| features with one | 222 | 8 | 185 | 18 | 1 | 55 |

E2E in any client: 192. Unit tests only: 50. Gated suites only: 3. User-visible features of a client with no E2E test in that client: web 38, extension 197, desktop 217.

Tests read: 79 E2E specs (79 tagged), 228 unit test files (228 tagged), 7 Rust files with `// covers:`.
