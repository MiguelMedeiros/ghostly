...
**317 features**, 311 covered by at least one test (98%), 6 on the [allow-untested list](../e2e/allow-untested.json).

| | Unit | Rust | E2E web | E2E ext | E2E desktop | Gated |
|---|---:|---:|---:|---:|---:|---:|
| features with one | 254 | 18 | 209 | 54 | 2 | 93 |

E2E in any client: 216. Unit tests only: 62. Gated suites only: 2. User-visible features of a client with no E2E test in that client: web 39, extension 187, desktop 238.

Tests read: 98 E2E specs (98 tagged), 265 unit test files (265 tagged), 13 Rust files with `// covers:`.
