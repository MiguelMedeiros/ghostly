...
- **[Report a vulnerability](https://github.com/MiguelMedeiros/ghostly/security/advisories/new)** on GitHub. It is private, and the fix is prepared in a private fork attached to the same advisory.
