...
export interface InPageHostOptions
  extends Pick<BrowserHost, "version" | "notice" | "updates" | "features" | "requestLocalAccess" | "openService" | "oidc" | "atproto" | "openPaymentLink" | "shareText" | "readClipboardText" | "openPubkyPassport"> {
  node?: NodeOptions;
